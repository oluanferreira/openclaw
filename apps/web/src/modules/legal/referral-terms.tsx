...
export const ReferralTerms = async () => {
...
const TermsEN = () => (
  <>
    ...
    <p>
      ...
      referring new paying customers to the Service. By participating, you agree
      to these terms.
    </p>
    ...
    <p>
      ...
      are calculated on the gross subscription payment amount before any fees or
      taxes.
    </p>
    ...
    <p>
      ...
      payment made by your referred customers for as long as their subscription
      remains active. If a referred customer cancels and later resubscribes, the
      referral link is not restored.
    </p>
    ...
    <ul>
      ...
      <li>
        Payouts are processed on the <strong>10th of each month</strong> for the
        previous month&apos;s commissions
      </li>
      <li>
    ...
    <p>
      Commissions are tracked in the original payment currency and converted to
      USD equivalent for reporting. Payout amounts are calculated in USDT based
      on the USD equivalent at the time of the original payment.
    </p>

    <h2>7. Referral Tracking</h2>
    <p>
      Referrals are tracked via your unique referral link. A 30-day first-click
      attribution cookie is used. The referral is credited when the referred
      user completes their first payment.
    </p>
    ...
    <ul>
      <li>
        <strong>Self-referral:</strong> Referring yourself or your own accounts
      </li>
      <li>
      ...
      <li>
        <strong>Brand misuse:</strong> Misrepresenting yourself as ClaWin1Click
        staff or partner
      </li>
    </ul>
    ...
    <p>
      ...
      commission is restored. Repeated disputes from a referrer&apos;s referrals
      may trigger a review of the referrer&apos;s account.
    </p>

    <h2>10. Suspension and Termination</h2>
    <p>
      We reserve the right to suspend or terminate your participation in the
      Program at any time for violation of these terms or suspected fraud. Upon
      termination, pending commissions below the payout threshold are forfeited.
      Earned and processed payouts are not affected.
    </p>
    ...
    <p>
      When promoting the Service on social media, you must clearly disclose your
      referral relationship (e.g., using #ad or #referral). This is required by
      advertising regulations in most jurisdictions.
    </p>

    <h2>13. Modifications</h2>
    <p>
      We may modify these terms at any time. Material changes will be
      communicated via email or dashboard notification. Continued participation
      after changes constitutes acceptance of the modified terms.
    </p>

    <h2>14. Limitation of Liability</h2>
    <p>
      ClaWin1Click is not liable for delayed or failed payouts due to blockchain
      network issues, incorrect wallet addresses provided by you, or force
      majeure events. Our maximum liability is limited to the unpaid commission
...
const TermsPT = () => (
  <>
    ...
    <p>
      Comissão máxima total por pagamento em todos os níveis: 30%. As comissões
      são calculadas sobre o valor bruto do pagamento da assinatura, antes de
      taxas ou impostos.
    </p>
    ...
    <ul>
      ...
      <li>
        Você é responsável por fornecer um endereço de carteira correto e ativo
      </li>
    </ul>
    ...
    <p>
      ...
      calculados em USDT com base no equivalente em USD no momento do pagamento
      original.
    </p>
    ...
    <p>
      As seguintes práticas são estritamente proibidas e resultarão em suspensão
      imediata:
    </p>
    <ul>
      <li>
      ...
      <li>
        <strong>Spam:</strong> Mensagens em massa não solicitadas ou publicidade
        enganosa
      </li>
      <li>
    ...
    <p>
      ...
      associada é anulada. Se a disputa for resolvida a nosso favor, a comissão
      é restaurada. Disputas repetidas dos indicados de um indicador podem
      acionar uma revisão da conta.
    </p>
    ...
    <p>
      ...
      fraude. Após o encerramento, comissões pendentes abaixo do limite de saque
      são perdidas. Pagamentos já processados não são afetados.
    </p>

    <h2>11. Responsabilidade Fiscal</h2>
    <p>
      Você é exclusivamente responsável por declarar e pagar quaisquer impostos
      devidos sobre comissões ganhas no Programa. A ClaWin1Click não retém
      impostos e não fornece consultoria fiscal. Recomendamos consultar um
      profissional tributário sobre suas obrigações.
    </p>

    <h2>12. Divulgação em Redes Sociais</h2>
    <p>
      Ao promover o Serviço em redes sociais, você deve divulgar claramente seu
      vínculo de indicação (ex: usando #publi ou #indicação). Isso é exigido
      pelas regulamentações de publicidade (CONAR) na maioria das jurisdições.
    </p>

    <h2>13. Modificações</h2>
    <p>
      Podemos modificar estes termos a qualquer momento. Alterações
      significativas serão comunicadas por e-mail ou notificação no dashboard. A
      participação continuada após as alterações constitui aceitação dos termos
      modificados.
    </p>

    <h2>14. Limitação de Responsabilidade</h2>
    <p>
      A ClaWin1Click não é responsável por pagamentos atrasados ou falhos devido
      a problemas na rede blockchain, endereços de carteira incorretos
...
const TermsES = () => (
  <>
    ...
    <p>
      El Programa de Referidos ClaWin1Click (&quot;Programa&quot;) permite a los
      suscriptores activos (&quot;Referidores&quot;) ganar comisiones
    ...
    <p>
      El Programa utiliza un modelo de comisión de 3 niveles basado en los pagos
      de suscripción del cliente referido:
    </p>
    <ul>
      <li>
      ...
      <li>
        <strong>Nivel 2 (Referido del referido):</strong> 8% del monto del pago
      </li>
      <li>
    ...
    <p>
      ...
      se calculan sobre el monto bruto del pago de suscripción, antes de cargos
      o impuestos.
    </p>
    ...
    <p>
      Las comisiones se rastrean en la moneda original del pago y se convierten
      a equivalente en USD para reportes. Los montos de pago se calculan en USDT
      basándose en el equivalente en USD al momento del pago original.
    </p>

    <h2>7. Seguimiento de Referidos</h2>
    <p>
      Los referidos se rastrean mediante tu enlace único. Se utiliza una cookie
      de atribución first-click de 30 días. El referido se acredita cuando el
      usuario referido completa su primer pago.
    </p>
    ...
    <p>
      ...
      asociada se anula. Si la disputa se resuelve a nuestro favor, la comisión
      se restaura. Disputas repetidas de los referidos de un referidor pueden
      activar una revisión de la cuenta.
    </p>
    ...
    <p>
      ...
      significativos se comunicarán por correo electrónico o notificación en el
      dashboard. La participación continuada después de los cambios constituye
    ...
    <p>
      ...
      proporcionadas por ti, o eventos de fuerza mayor. Nuestra responsabilidad
      máxima se limita al saldo de comisiones no pagadas en tu cuenta.
    </p>
